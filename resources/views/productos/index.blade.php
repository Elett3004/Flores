        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <tr class="hover:bg-rose-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-center space-x-2">
                                        ...
                                        <form action="{{ route('productos.destroy', $producto->id) }}" method="POST"
                                            class="inline"
                                            onsubmit="return confirm('¿Estás seguro de que deseas desactivar este producto?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
            ...
            @else
                <div class="bg-white rounded-2xl shadow-lg p-8 text-center border border-rose-100">
                    ...
                    <p class="text-gray-600 text-lg">No hay pedidos aún. ¡Crea uno para llenar de flores tu catálogo!
                    </p>
                </div>
            @endif
