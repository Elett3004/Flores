        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 border border-rose-100">
            ...
            <div class="mb-8 text-center">
                ...
                <h1
                    ...
                    Editar Pedido</h1>
                <p class="text-rose-600 font-medium">Actualiza la información del pedido</p>
            </div>
            ...
            <form action="{{ route('productos.update', $producto->id) }}" method="post">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="nombre" name="nombre" value="{{ $producto->nombre }}" required
                        ...
                        placeholder="Ej: Laptop Dell XPS 13…" aria-describedby="nombre-help">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descripcion" name="descripcion" required rows="4" spellcheck="false"
                        ...
                        placeholder="Describe tu producto aquí…" aria-describedby="descripcion-help">{{ $producto->descripcion }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    <label for="fecha_entrega" class="block text-sm font-semibold text-rose-900 mb-2">Fecha de
                        Entrega</label>
                    <input type="date" id="fecha_entrega" name="fecha_entrega" value="{{ $producto->fecha_entrega }}"
                        class="w-full px-4 py-2 border-2 border-rose-200 rounded-lg focus-visible:ring-2 focus-visible:ring-rose-400 focus-visible:border-rose-400 focus-visible:outline-none transition-colors duration-150 bg-rose-50"
                ...
                <div class="mb-6">
                    ...
                    <select id="estado" name="estado"
                        ...
                        <option value="terminado" {{ $producto->estado === 'terminado' ? 'selected' : '' }}>Terminado
                        </option>
                        <option value="cancelado" {{ $producto->estado === 'cancelado' ? 'selected' : '' }}>Cancelado
                        </option>
                    </select>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('productos.index') }}"
                        ...
                        aria-label="Cancelar edición de pedido">
                        Cancelar
                    </a>
                </div>
            </form>
